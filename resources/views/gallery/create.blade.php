    ...
    <div x-data="albumCreate">
        ...
        <div class="panel">
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Add a new album to Gallery</p>
            </div>
            ...
            <form @submit.prevent="submit" enctype="multipart/form-data">
                ...
                <div class="flex items-center justify-end gap-3 mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <a href="{{ route('gallery.index') }}" class="btn btn-outline-danger">
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('albumCreate', () => ({
                ...
                submit() {
                    ...
                    submitFormData('{{ route('gallery.store') }}', formData).finally(() => {
