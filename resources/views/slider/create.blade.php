<x-layouts.app>
    <div x-data="slideCreate">
        ...
        <div class="panel">
            <div class="mb-6">
                <h5 class="text-xl font-semibold dark:text-white-light">Create New Slide</h5>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Add a new slide to the homepage slider</p>
            </div>
            ...
            <form @submit.prevent="submit" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <label for="media_file" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            <span x-text="formData.type === 'image' ? 'Image File' : 'Video File'"></span> <span class="text-danger">*</span>
                        </label>
                        ...
                        <div class="relative">
                            <input type="file" id="media_file" name="media_file" @change="handleMediaFile"
                        ...
                        <template x-if="mediaPreview">
                            <div class="mt-3">
                                <div class="relative inline-block">
                                    <template x-if="formData.type === 'image'">
                                        <img :src="mediaPreview" alt="Media preview" class="h-32 w-auto rounded-lg border border-gray-300 dark:border-gray-600">
                                    </template>
                                    ...
                                    <button type="button" @click="removeMedia" class="absolute -top-2 -right-2 bg-danger text-white rounded-full h-6 w-6 flex items-center justify-center hover:bg-danger/80">
                    ...
                    <div>
                        ...
                        <input type="text" id="alt_text" name="alt_text" x-model="formData.alt_text" class="form-input" placeholder="Enter alt text for accessibility">
                ...
                <div class="flex items-center justify-end gap-3 mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <a href="{{ route('slider.index') }}" class="btn btn-outline-danger">
                        <i class="fa-solid fa-times mr-2"></i>
                        Cancel
                    </a>
                    <button type="submit" class="btn btn-primary" :disabled="submitting">
                        <i class="fa-solid fa-save mr-2"></i>
                        <span x-text="submitting ? 'Creating...' : 'Create Slide'"></span>
                    </button>
                </div>
            </form>
        </div>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('slideCreate', () => ({
                ...
                handleTypeChange() {
                    // Clear media file when type changes
                    this.removeMedia();
                },
                ...
                submit() {
                    ...
                    submitFormData('{{ route('slider.store') }}', formData).finally(() => {
