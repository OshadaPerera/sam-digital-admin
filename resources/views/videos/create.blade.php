<x-layouts.app>
    <div x-data="videoCreate">
        ...
        <div class="panel">
            <div class="mb-6">
                <h5 class="text-xl font-semibold dark:text-white-light">Add New Video</h5>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Add a new video by providing the video URL</p>
            </div>
            ...
            <form @submit.prevent="submit">
                ...
                <div class="flex items-center justify-end gap-3 mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <button type="submit" class="btn btn-primary" :disabled="submitting">
                        ...
                        <span x-text="submitting ? 'Creating...' : 'Create Video'"></span>
                    </button>
                </div>
            </form>
        </div>
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('videoCreate', () => ({
                ...
                submit() {
                    ...
                    submitFormData('{{ route('videos.store') }}', formData).finally(() => {
