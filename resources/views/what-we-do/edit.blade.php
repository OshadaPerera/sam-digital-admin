<x-layouts.app>
    <div x-data="albumEdit">
        <ul class="flex space-x-2 rtl:space-x-reverse mb-6">
            <li>
                <a href="{{ route('what-we-do.index') }}" class="text-primary hover:underline">What We Do</a>
            </li>
            <li class="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                <a href="{{ route('what-we-do.show', $album) }}" class="text-primary hover:underline">{{ $album->title }}</a>
            </li>
            <li class="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                <span>Edit</span>
            </li>
        ...
        <div class="panel">
            <div class="mb-6">
                <h5 class="text-xl font-semibold dark:text-white-light">Edit Album</h5>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Update album details</p>
            </div>
            ...
            <form @submit.prevent="submit" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        @if ($album->cover_image)
                            <div class="mb-3">
                                ...
                                <div class="relative inline-block" x-show="!coverImagePreview">
                                    <img src="{{ asset('storage/' . $album->cover_image) }}" alt="Current cover" class="h-32 w-auto rounded-lg border border-gray-300 dark:border-gray-600">
                                </div>
                            </div>
                        @endif
                        ...
                        <template x-if="coverImagePreview">
                            <div class="mt-3">
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">New Cover:</p>
                                <div class="relative inline-block">
                                    <img :src="coverImagePreview" alt="New cover preview" class="h-32 w-auto rounded-lg border border-gray-300 dark:border-gray-600">
                ...
                <div class="flex items-center justify-end gap-3 mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <a href="{{ route('what-we-do.show', $album) }}" class="btn btn-outline-danger">
                        <i class="fa-solid fa-times mr-2"></i>
                        Cancel
                    </a>
                    <button type="submit" class="btn btn-primary" :disabled="submitting">
                        <i class="fa-solid fa-save mr-2"></i>
                        <span x-text="submitting ? 'Updating...' : 'Update Album'"></span>
                    </button>
                </div>
            </form>
        </div>
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('albumEdit', () => ({
                ...
                submit() {
                    ...
                    submitFormData('{{ route('what-we-do.update', $album) }}', formData).finally(() => {
